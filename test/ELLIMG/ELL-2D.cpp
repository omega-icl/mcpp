...
// reduced source tree that does not provide interval.hpp. In the full MC++ tree,
// leave it undefined and use the usual interval back-end selection below.
...
void test_intersection_ea()
{
  ...
  //hyperplane x1+x2 <= 0
  dcv a1(n,arma::fill::zeros); double b1(0.);
  a1(0) = 1.;   a1(1) = 1.;
...
//  q0(1) = 1.;     Q0(1,0) = 2.; Q0(1,1) = 3.;
  q0(0) = 3.;     Q0(0,0) = 2.;
  q0(1) = 4.;     Q0(1,0) = 1.; Q0(0,1) = 1.; Q0(1,1) = 2.;
  #endif
