...
////////////////////////////////////////////////////////////////////////
{
  ...
  try
  {
    ...
    for (int iX = 0; iX < NX; iX++)
    {
      ...
      MC MCF = myfunc(MCX);
#endif
      res << setw(14) << DX << setw(14) << DF << setw(14) << MCF.l() << setw(14)
          << MCF.u() << setw(14) << MCF.cv() << setw(14) << MCF.cc() << setw(14)
          << MCF.cvsub(0) << setw(14) << MCF.ccsub(0) << setw(14)
          << MCFREF.cv() + MCFREF.cvsub(0) * (DX - XREF) << setw(14)
          << MCFREF.cc() + MCFREF.ccsub(0) * (DX - XREF) << endl;
    }
#endif
  }
