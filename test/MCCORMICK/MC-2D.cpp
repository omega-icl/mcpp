...
{
  return fstep(1 - x * y) *
             (2 * (x + y) - exp(x * y + 1) - 0.5 * sin(6 * y - 1) * sqr(x)) +
         0.5 * sin(6 * y - 1) * sqr(x);
}
  ...
  try
  {
    ...
    for (int iX = 0; iX < NX; iX++)
    {
      for (int iY = 0; iY < NY; iY++)
      {
        ...
        allsub << setw(14) << DX << setw(14) << DY << setw(14) << DF << setw(14)
               << MCF.l() << setw(14) << MCF.u() << setw(14) << MCF.cv()
               << setw(14) << MCF.cc() << setw(14) << MCF.cvsub(0) << setw(14)
               << MCF.ccsub(0) << setw(14) << MCF.cvsub(1) << setw(14)
               << MCF.ccsub(1) << endl;
        ...
        MCF = myfunc(MCX, MCY);
#endif
        dirsub << setw(14) << DX << setw(14) << DY << setw(14) << DF << setw(14)
               << MCF.l() << setw(14) << MCF.u() << setw(14) << MCF.cv()
               << setw(14) << MCF.cc() << setw(14) << MCF.cvsub(0) << setw(14)
               << MCF.ccsub(0) << endl;
      }
