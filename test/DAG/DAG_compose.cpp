...
int test_substitute3()
{
  std::cout << "\n==============================================\ntest_substitute3:\n";
  std::cout << "Substitute VAR variables (substitute works for both VAR and AUX)\n";
...
int test_substitute6()
{
  ...
  try{
    ...
    if( eObj.ierr() == mc::FFBase::Exceptions::NOTVAR ){
      std::cout << "PASS: compose correctly threw NOTVAR: " << eObj.what() << std::endl;
    }
    else{
      std::cout << "FAIL: compose threw unexpected exception: " << eObj.what() << std::endl;
      return 1;
    }
  }
