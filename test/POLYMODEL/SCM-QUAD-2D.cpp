...
{ 
  ...
  quad.options.ORDER = SQuad::Options::INC;// DEC;//
  quad.options.BASIS = SQuad::Options::POW;//CHEB;//
  tStart = mc::userclock();
  for( unsigned i=0; i<NF; i++ ){
    ...
    //std::cout << F[i].display( coefmon, SQuad::Options::POW );
    //double viol = quad.process( coefmon, SQuad::Options::POW, true );
