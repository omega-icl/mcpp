...
main()
{
  ...
  for (int iX = 0; iX < NX; iX++)
  {
    for (int iY = 0; iY < NY; iY++)
    {
      ...
      I RF = F.R(), IF = F.B();
      res << std::setw(14) << DXY[0] << std::setw(14) << DXY[1] << std::setw(14)
          << DF << std::setw(14) << PF << std::setw(14) << Op<I>::l(RF)
          << std::setw(14) << Op<I>::u(RF) << std::setw(14) << Op<I>::l(IF)
          << std::setw(14) << Op<I>::u(IF) << std::endl;
    }
    res << endl;
  }
#endif
