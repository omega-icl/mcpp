...
myfunc(const T& x, const T& y)
{
  return 1.86360571672641 *
         (0.14220168012508 *
              (1 +
               2.23606797749979 *
                   sqrt(64.2558879895505 *
                            sqr(0.194030125231034 - 0.166666666666667 * x) +
                        0.451453304154821 *
                            sqr((-0.404841797459896) - 0.166666666666667 * y)) +
               1.66666666666667 *
                   (64.2558879895505 *
                        sqr(0.194030125231034 - 0.166666666666667 * x) +
                    0.451453304154821 *
          ...
          0.0468045532937668 *
              (1 +
               2.23606797749979 *
                   sqrt(64.2558879895505 *
                            sqr(0.268324435572052 - 0.166666666666667 * x) +
                        0.451453304154821 *
                            sqr((-0.220830234095203) - 0.166666666666667 * y)) +
               1.66666666666667 *
                   (64.2558879895505 *
                        sqr(0.268324435572052 - 0.166666666666667 * x) +
                    0.451453304154821 *
          ...
          0.436827958615331 *
              (1 +
               2.23606797749979 *
                   sqrt(64.2558879895505 *
                            sqr((-0.0505822037784427) - 0.166666666666667 * x) +
                        0.451453304154821 *
                            sqr(0.190399166851636 - 0.166666666666667 * y)) +
               1.66666666666667 *
                   (64.2558879895505 *
                        sqr((-0.0505822037784427) - 0.166666666666667 * x) +
                    0.451453304154821 *
          ...
          0.0405780260973915 *
              (1 +
               2.23606797749979 *
                   sqrt(64.2558879895505 *
                            sqr(0.335653234585858 - 0.166666666666667 * x) +
                        0.451453304154821 *
                            sqr(0.319274707641782 - 0.166666666666667 * y)) +
               1.66666666666667 *
                   (64.2558879895505 *
                        sqr(0.335653234585858 - 0.166666666666667 * x) +
                    0.451453304154821 *
          ...
          0.0383717635737363 *
              (1 +
               2.23606797749979 *
                   sqrt(64.2558879895505 *
                            sqr(0.416115262788179 - 0.166666666666667 * x) +
                        0.451453304154821 * sqr((-0.0829399801155143) -
                                                0.166666666666667 * y)) +
               1.66666666666667 *
                   (64.2558879895505 *
                        sqr(0.416115262788179 - 0.166666666666667 * x) +
                    0.451453304154821 *
                        sqr((-0.0829399801155143) - 0.166666666666667 * y))) *
              exp(-2.23606797749979 *
                  sqrt(64.2558879895505 *
                           sqr(0.416115262788179 - 0.166666666666667 * x) +
                       0.451453304154821 * sqr((-0.0829399801155143) -
          ...
          0.226121620987036 *
              (1 +
               2.23606797749979 *
                   sqrt(64.2558879895505 *
                            sqr((-0.324344059222606) - 0.166666666666667 * x) +
                        0.451453304154821 *
                            sqr(0.0775173811415889 - 0.166666666666667 * y)) +
               1.66666666666667 *
                   (64.2558879895505 *
                        sqr((-0.324344059222606) - 0.166666666666667 * x) +
                    0.451453304154821 *
          ...
          0.055301550115541 *
              (1 +
               2.23606797749979 *
                   sqrt(64.2558879895505 *
                            sqr((-0.289414019566429) - 0.166666666666667 * x) +
                        0.451453304154821 *
                            sqr((-0.337636568589209) - 0.166666666666667 * y)) +
               1.66666666666667 *
                   (64.2558879895505 *
                        sqr((-0.289414019566429) - 0.166666666666667 * x) +
                    0.451453304154821 *
          ...
          0.220359443423157 *
              (1 +
               2.23606797749979 *
                   sqrt(64.2558879895505 *
                            sqr((-0.120888900038076) - 0.166666666666667 * x) +
                        0.451453304154821 *
                            sqr((-0.125103261913789) - 0.166666666666667 * y)) +
               1.66666666666667 *
                   (64.2558879895505 *
                        sqr((-0.120888900038076) - 0.166666666666667 * x) +
                    0.451453304154821 *
          ...
          0.0439612252066741 *
              (1 +
               2.23606797749979 *
                   sqrt(64.2558879895505 *
                            sqr(0.0826904704977199 - 0.166666666666667 * x) +
                        0.451453304154821 *
                            sqr(0.458984274331446 - 0.166666666666667 * y)) +
               1.66666666666667 *
                   (64.2558879895505 *
                        sqr(0.0826904704977199 - 0.166666666666667 * x) +
                    0.451453304154821 *
          ...
          0.0560980731767207 *
              (1 +
               2.23606797749979 *
                   sqrt(64.2558879895505 *
                            sqr((-0.435192808594306) - 0.166666666666667 * x) +
                        0.451453304154821 *
                            sqr(0.220400711043696 - 0.166666666666667 * y)) +
               1.66666666666667 *
                   (64.2558879895505 *
                        sqr((-0.435192808594306) - 0.166666666666667 * x) +
                    0.451453304154821 *
...
main()
{
  ...
  try
  {
    ...
    for (int iX = 0; iX < NX; iX++)
    {
      ...
      {
        double DXY[2] = {XL + iX * (XU - XL) / (NX - 1.),
                         YL + iY * (YU - YL) / (NY - 1.)};
        double DF     = myfunc(DXY[0], DXY[1]);
#if defined(USE_SPARSE) && defined(USE_INTCOEF)
        I IF      = CVF.P(std::map<unsigned, double>(
            {std::make_pair(0, DXY[0]), std::make_pair(1, DXY[1])}));
        double PF = Op<I>::mid(IF);
#elif defined(USE_SPARSE)
        double PF = CVF.P(std::map<unsigned, double>(
            {std::make_pair(0, DXY[0]), std::make_pair(1, DXY[1])}));
        I IF      = PF + CVF.R();
#else
        double PF = CVF.P(DXY);
        ...
        res << std::setw(14) << DXY[0] << std::setw(14) << DXY[1]
            << std::setw(14) << DF << std::setw(14) << PF << std::setw(14)
            << Op<I>::l(IF) << setw(14) << Op<I>::u(IF) << std::setw(14)
            << Op<I>::l(CVF.B()) << std::setw(14) << Op<I>::u(CVF.B())
            << std::endl;
#endif
      }
      res << endl;
