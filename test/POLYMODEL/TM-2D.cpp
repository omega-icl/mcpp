...
////////////////////////////////////////////////////////////////////////
{
  ...
  try
  {
    ...
    std::cout << "\nMcCormick-Taylor model of df/dx: " << FTVMCF.d(0)
              << std::endl;
    std::cout << "\nMcCormick-Taylor model of df/dy: " << FTVMCF.d(1)
              << std::endl;
    ...
    for (int iX = 0; iX < NX; iX++)
    {
      for (int iY = 0; iY < NY; iY++)
      {
        ...
        res << std::setw(14) << DXY[0] << std::setw(14) << DXY[1]
            << std::setw(14) << DF << std::setw(14) << MCF.l() << std::setw(14)
            << MCF.u() << std::setw(14) << MCF.cv() << std::setw(14) << MCF.cc()
            << std::setw(14) << TVMCF.B().l() << std::setw(14) << TVMCF.B().u()
            << std::setw(14) << TVMCF.B().cv() << std::setw(14)
            << TVMCF.B().cc() << std::setw(14) << TVMCF.B().cvsub(0)
            << std::setw(14) << TVMCF.B().ccsub(0) << std::setw(14)
            << TVMCF.B().cvsub(1) << std::setw(14) << TVMCF.B().ccsub(1)
            << std::endl;
#endif
      }
      res << std::endl;
  ...
  {
    cerr << "Error " << eObj.ierr() << " in Taylor model computation:" << endl
         << eObj.what() << endl
         << "Aborts." << endl;
    return eObj.ierr();
  }
