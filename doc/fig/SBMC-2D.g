...
set terminal pngcairo size 540,280 enhanced font 'Verdana,7'
set out "SB-2D.png"
set multiplot layout 1,2
#
splot 'SB-2D.out' u 1:2:7 tit 'function' w l lt 1 lc 1 lw .5, \
  '' u 1:2:8 tit 'function bounds' w l lt 1 lc 3 lw .5, \
  '' u 1:2:9 tit '' w l lt 1 lc 3 lw .5
#
splot 'SB-2D.out' u 1:2:3 tit 'lambda min' w l lt 1 lc 1 lw .5, \
  '' u 1:2:4 tit 'lambda max' w l lt 1 lc 2 lw .5, \
  '' u 1:2:5 tit 'spectral bounds' w l lt 1 lc 3 lw .5, \
  '' u 1:2:6 tit '' w l lt 1 lc 3 lw .5
#
unset multiplot
pause -1 "<ENTER> TO CONTINUE"
