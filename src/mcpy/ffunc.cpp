...
pyFFGraph
 ...
 .def( "bdiff", []( mc::FFGraph<>& G, std::vector<mc::FFVar const*> const& vDep, std::vector<mc::FFVar const*> const& vIndep ){ return G.SBAD( vDep, vIndep ); }, py::return_value_policy::reference_internal, "apply backward differentiation" )
