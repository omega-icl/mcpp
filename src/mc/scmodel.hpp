...
//! @brief C++ structure for specialization of the mc::Op templated structure to allow usage of the Chebyshev model type mc::SCVar from DAG evaluation and as template parameter inside other MC++ types
template <> template<typename T> struct Op< mc::SCVar<T> >
{
