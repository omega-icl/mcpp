...
mc_smon(py::module_& m)
{
  ...
  pySMonExceptions.def("ierr", &SMon::Exceptions::ierr, "Return error flag")
  ...
  pySMon
      ...
      .def(py::init<SMon const&>(), "Copy constructor")
      // Accessors
      .def_readonly("tord", &SMon::tord, "Monomial total order")
      ...
      // Methods
      .def("exp", &SMon::exp, py::arg("var"),
           "Exponent of variable 'var' in monomial")
      .def("gcexp", &SMon::gcexp, "Greatest common exponent of terms")
      .def("lexp", &SMon::lexp, "Least exponent among all terms")
      .def("gexp", &SMon::gexp, "Greatest exponent among all terms")
      .def("hull", &SMon::hull, py::arg("mon"), "Union with other monomial")
      .def("inter", &SMon::inter, py::arg("mon"), "Test for intersection")
      .def("subset", &SMon::subset, py::arg("mon"), "Test for proper subset")
      .def("subseteq", &SMon::subseteq, py::arg("mon"), "Test for subset")
      .def("display", &SMon::display, py::arg("basis") = 0,
