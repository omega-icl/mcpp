...
mc_ffdagext(py::module_& m)
{
  ...
  pyDAGEXT.def(py::init<>(), "default constructor")
      .def(py::init<mc::FFGraph*, std::vector<mc::FFVar> const&,
           ...
           "data constructor")
      .def(py::init<mc::DAGEXT<I> const&>(), "copy constructor")
      .def_readwrite("options", &mc::DAGEXT<I>::options)
      .def(
          "set",
      ...
      .def_property_readonly(
          ...
          py::return_value_policy::reference_internal, "DAGEXT internal DAG")
      .def_property_readonly(
      ...
      .def_property_readonly(
          ...
          py::return_value_policy::reference_internal, "DAGEXT input variables")
      .def_property_readonly(
  ...
  pyFFDAGEXT
      .def(py::init<bool const>(), py::arg("sparse") = true,
           "default constructor")
      .def(py::init<mc::FFDAGEXT<I> const&>(), "copy constructor")
      .def(
          "__call__",
          ...
          py::arg("dag"), "define DAGEXT operation in DAG")
      .def(
          "__call__",
          ...
          py::arg("var"), py::arg("dag"), "define DAGEXT operation in DAG")
      .def_property_readonly(
          "name", [](mc::FFDAGEXT<I> const& self) { return self.name(); },
          py::return_value_policy::reference_internal, "DAGEXT operation name")
      .def("__str__",
  ...
  py::class_<std::set<mc::FFDAGEXT<I>::Options::RELAX_TYPE>>(
      m, "RELAX_FFDAGEXT", py::module_local())
      .def(py::init<>())
      .def(
          "add",
