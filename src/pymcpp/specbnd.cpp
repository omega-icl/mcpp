...
mc_specbnd(py::module& m)
{
  ...
  pySpecbnd
      ...
      .def(py::init<I const&, size_t, size_t>(), py::arg("B"), py::arg("i"),
           py::arg("n"),
           "constructor for variable with range B, index i and n independent "
           "variables")
      .def(py::init<SB const&>(), "copy constructor")
      // Modifiers
      .def(
      ...
      .def_property_readonly(
          "n", [](SB const& self) { return self.n(); },
          "number of independent variables")
      .def_property_readonly(
          "I", [](SB const& self) { return self.I(); }, "function range")
      .def_property_readonly(
          "FI", [](SB const& self) { return self.FI(); }, "gradient range")
      .def_property_readonly(
          "SI", [](SB const& self) { return self.SI(); }, "spectral range")
      .def_static(
          "spectrum",
          ...
          py::arg("hess"), "compute spectrum of dense symmetric real matrix")
      .def_static(
          "spectrum",
      ...
      .def_static(
          ...
          py::arg("hess"), py::arg("scal") = std::vector<double>(),
          "compute spectral bound of dense symmetric interval matrix using "
          "Gershgorin's method")
      .def_static(
          "spectral_bound_gershgorin",
          ...
          "compute spectral bound of sparse symmetric interval matrix using "
          "Gershgorin's method")
      .def_static(
          "spectral_bound_rohn",
      ...
      .def_static(
          ...
          py::arg("col") = std::vector<int>(),
          "compute spectral bound of symmetric interval matrix using Rohn's "
          "method")
      .def_static(
      ...
      .def_static(
          ...
          py::arg("hess"), py::arg("ndim"), py::arg("row") = std::vector<int>(),
          py::arg("col") = std::vector<int>(),
          "compute spectral bound of symmetric interval matrix using Hertz's "
          "method")
      .def("__str__",
           [](SB const& self)
           {
