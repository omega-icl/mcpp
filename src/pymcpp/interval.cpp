...
// .def_property_readonly( "u", []( I& self ){ return mc::Op<I>::u(self); } )
 ...
 .def_property( "u", []( I& self ){ return mc::Op<I>::u(self); },
      ...
      .def("__pow__",
           [](I const& i, int const n) { return mc::Op<I>::pow(i, n); })
      .def("__pow__",
  ...
  m.def("pow", [](double const& r, I const& y)
        { return mc::Op<I>::exp(y * std::log(r)); });
  m.def("cheb",
        [](I const& x, unsigned const n) { return mc::Op<I>::cheb(x, n); });
