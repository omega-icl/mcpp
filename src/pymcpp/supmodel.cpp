...
mc_supmodel(py::module& m)
{
  ...
  pyPWLSModel.def(py::init<size_t const&>(), py::arg("nvar"), "constructor")
      .def_readwrite("options", &PWLSM::options)
      .def_property_readonly(
          "nvar", [](PWLSM& self) { return self.nvar(); },
          "number of independent variables")
      .def_property_readonly(
          "lbdvar", [](PWLSM& self) { return self.lbdvar(); },
          "lower bounds of independent variables")
      .def_property_readonly(
          "ubdvar", [](PWLSM& self) { return self.ubdvar(); },
      ...
      .def(
          ...
          "refine superposition underestimator to satisfy natural lower bound "
          "lbd")
      .def(
          "oref", [](PWLSM& self, PWLSV& var, double const& ubd)
          { return self.oref(var, ubd); },
          "refine superposition overestimator to satisfy natural upper bound "
          "ubd");

  pyPWLSModelOptions.def(py::init<>(), "Default constructor")
      .def(py::init<PWLSM::Options const&>(), "Copy constructor")
      .def_readwrite("PROD_METH", &PWLSM::Options::PROD_METH,
      ...
      .def_readwrite("REF_WEIGHT", &PWLSM::Options::REF_WEIGHT,
                     "Weight in the overloaded functions mc::min and mc::max")
      .def_readwrite("MAX_SUBDIV", &PWLSM::Options::MAX_SUBDIV,
                     "Maximal number of subdivisions, for univariate "
                     "estimators on adaptive grids only")
      .def_readwrite("USE_SHADOW", &PWLSM::Options::USE_SHADOW,
                     "Whether to enable shadow estimators")
      .def_readwrite("DISPLAY_SHADOW", &PWLSM::Options::DISPLAY_SHADOW,
                     "Whether to display shadow estimators")
      .def_readwrite("DISPLAY_DIGITS", &PWLSM::Options::DISPLAY_DIGITS,
  ...
  py::enum_<PWLSM::Options::PROD_REF>(pyPWLSModelOptions, "PROD_REF",
      ...
      .value("PARTIAL", PWLSM::Options::PROD_REF::PARTIAL,
             "DC decomposition w/ range rescaling")
      .value("FULL", PWLSM::Options::PROD_REF::FULL,
             "DC decomposition w/ range and midpoint rescaling")
      .value("LOG", PWLSM::Options::PROD_REF::LOG,
             "Log-transform w/ range and midpoint rescaling")
      .export_values();

  pyPWLSVar
      .def(py::init<double const&>(), py::arg("cst") = 0.,
           "constructor for constant")
      .def(py::init<PWLSM&>(), py::arg("mod"), "default constructor")
      ...
      .def(py::init<PWLSM&, unsigned int, PWLU const&>(), py::arg("mod"),
           py::arg("ndx"), py::arg("est"), "constructor for variable")
      .def(py::init<PWLSV const&>(), "copy constructor")
      .def(
      ...
      .def(
          ...
          py::arg("est"), "set independent variable")
      .def(
          "set", [](PWLSV& self, double const& cst) { return self.set(cst); },
          py::arg("cst"), "set constant")
      .def_property_readonly(
          "ndep", [](PWLSV& self) { return self.ndep(); },
          "number of dependencies")
      .def_property_readonly(
          "sdep", [](PWLSV& self) { return self.sdep(); },
          "set of dependencies")
      .def_property_readonly(
          "cst", [](PWLSV& self) { return self.cst(); }, "constant field")
      .def(
          "uest", [](PWLSV& self, unsigned int opt) { return self.uest(opt); },
          py::arg("opt") = 0, "superposition underestimator")
      .def(
          "oest", [](PWLSV& self, unsigned int opt) { return self.oest(opt); },
          py::arg("opt") = 0, "superposition overestimator")
      .def(
          "l", [](PWLSV& self, unsigned int opt) { return self.l(opt); },
          py::arg("opt") = 2, "lower bound of superposition relaxation")
      .def(
          "u", [](PWLSV& self, unsigned int opt) { return self.u(opt); },
          py::arg("opt") = 2, "upper bound of superposition relaxation")
      .def(
          "uval",
          [](PWLSV& self, std::map<unsigned int, double> const& x,
             unsigned int opt) { return self.uval(x, opt); },
          py::arg("x"), py::arg("opt") = 2,
  ...
  m.def("cheb",
        [](PWLSV const& x, unsigned const n) { return mc::cheb(x, n); });
  ...
  pyPWLU.def(py::init<>(), "default constructor")
      ...
      .def(
          ...
          py::arg("N") = 1, "set independent variable")
      .def(
          "set", [](PWLU& self, double const& xL, std::vector<double> const& dx)
          { return self.set(xL, dx); }, py::arg("xL"), py::arg("dx"),
          "set independent variable")
      .def(
          "insert", [](PWLU& self, std::vector<double> const& dx)
          { return self.insert(dx); }, py::arg("dx"), "insert breakpoints")
      .def(
          "insert", [](PWLU& self, double const& x) { return self.insert(x); },
          py::arg("x"), "insert breakpoint")
      .def_property_readonly(
          "l", [](PWLU& self) { return self.l(); },
          "lower bound of univariate estimator")
      .def_property_readonly(
          "u", [](PWLU& self) { return self.u(); },
          "upper bound of univariate estimator")
      .def_property_readonly(
          "w", [](PWLU& self) { return self.w(); },
      ...
      .def(
          ...
          { return self.min(cutoff); }, "cut-off estimator from below")
      .def(
          "max", [](PWLU& self, double const& cutoff)
          { return self.max(cutoff); }, "cut-off estimator from above")
      .def(
          "clean",
          [](PWLU& self, bool const under) { return self.clean(under); },
          "remove partitions with step smaller than set tolerances "
          "(options.BKPTATOl, options.BKPTRTOL)")
      .def(
          "merge",
          [](PWLU& self, bool const under) { return self.clean(under); },
          "merge partitions with identical slope within set tolerances "
          "(options.BKPTATOl, options.BKPTRTOL)")
      .def(
          "reduce", [](PWLU& self, bool const under, size_t const nseg)
          { return self.clean(under); },
          "reduce partition size to within nseg segments through successive "
          "relaxation");

  pyPWLUOptions.def(py::init<>(), "default constructor")
      .def(py::init<PWLU::Options const&>(), "copy constructor")
      .def_readwrite("BKPTATOL", &PWLU::Options::BKPTATOL,
                     "absolute tolerance in managing breakpoints")
      .def_readwrite("BKPTRTOL", &PWLU::Options::BKPTRTOL,
                     "relative tolerance in managing breakpoints")
      .def_readwrite("REDUCEMETH", &PWLU::Options::REDUCEMETH,
                     "Method for breakpoint reduction")
      .def_readwrite("DISPNUM", &PWLU::Options::DISPNUM,
                     "number of digits displayed")
      .def(
          "reset", [](PWLU::Options& self) { return self.reset(); },
          "reset options");
  ...
  pyPWCSModel.def(py::init<size_t const&>(), py::arg("nvar"), "constructor")
      .def_readwrite("options", &PWCSM::options)
      .def_property_readonly(
          "nvar", [](PWCSM& self) { return self.nvar(); },
          "number of independent variables")
      .def_property_readonly(
          "lbdvar", [](PWCSM& self) { return self.lbdvar(); },
          "lower bounds of independent variables")
      .def_property_readonly(
          "ubdvar", [](PWCSM& self) { return self.ubdvar(); },
          "upper bounds of independent variables")
      .def(
  ...
  pyPWCSModelOptions.def(py::init<>(), "default constructor")
      .def(py::init<PWCSM::Options const&>(), "copy constructor")
      .def_readwrite("PROD_METH", &PWCSM::Options::PROD_METH,
                     "reformulation method used for product terms")
      .def_readwrite(
          "PROD_CUT", &PWCSM::Options::PROD_CUT,
          "wwether to cut superposition relaxations for product terms")
      .def_readwrite("SUM_TOL", &PWCSM::Options::SUM_TOL,
                     "tolerance on range for univariate estimator propagation")
      .def_readwrite("REF_WEIGHT", &PWCSM::Options::REF_WEIGHT,
                     "Weight in the overloaded functions mc::min and mc::max")
      .def_readwrite("MAX_SUBDIV", &PWCSM::Options::MAX_SUBDIV,
                     "Maximal number of subdivisions, for univariate "
                     "estimators on adaptive grids only")
      .def_readwrite("USE_SHADOW", &PWCSM::Options::USE_SHADOW,
                     "whether to enable shadow estimators")
      .def_readwrite("DISPLAY_SHADOW", &PWCSM::Options::DISPLAY_SHADOW,
                     "whether to display shadow estimators")
      .def_readwrite("DISPLAY_DIGITS", &PWCSM::Options::DISPLAY_DIGITS,
                     "number of digits displayed")
      .def(
  ...
  pyPWCSVar
      ...
      .def(
          ...
          py::arg("cst"), "set constant")
      .def_property_readonly(
          "ndep", [](PWCSV& self) { return self.ndep(); },
          "number of dependencies")
      .def_property_readonly(
          "sdep", [](PWCSV& self) { return self.sdep(); },
          "set of dependencies")
      .def_property_readonly(
          "cst", [](PWCSV& self) { return self.cst(); }, "constant field")
      .def(
  ...
  m.def("cheb",
        [](PWCSV const& x, unsigned const n) { return mc::cheb(x, n); });
  ...
  pyPWCU.def(py::init<>(), "default constructor")
      .def(py::init<double const&, double const&, double const&,
                    size_t const&>(),
           py::arg("xL"), py::arg("xU"), py::arg("y"), py::arg("N"),
           "constructor of constant")
      .def(py::init<double const&, double const&, size_t const>(),
           py::arg("xL"), py::arg("xU"), py::arg("N"),
           "constructor of variable")
      .def(py::init<PWCU const&>(), "copy constructor")
      .def_readwrite_static("options", &PWCU::options)
      .def(
      ...
      .def(
          ...
          { return self.set(xL, xU, N); }, py::arg("xL"), py::arg("xU"),
          py::arg("N"), "set variable")
      .def_property_readonly(
          "l", [](PWCU& self) { return self.l(); },
          "lower bound of univariate estimator")
      .def_property_readonly(
          "u", [](PWCU& self) { return self.u(); },
          "upper bound of univariate estimator")
      .def_property_readonly(
          "w", [](PWCU& self) { return self.w(); },
          "width of univariate estimator")
      .def(
      ...
      .def(
          ...
          "evaluate univariate estimator (upper range)")
      .def_property_readonly(
          "n", [](PWCU& self) { return self.size(); }, "partition size")
      .def_property(
  ...
  pyPWCUOptions.def(py::init<>(), "default constructor")
      .def(py::init<PWCU::Options const&>(), "copy constructor")
      .def_readwrite("BKPTATOL", &PWCU::Options::BKPTATOL,
                     "absolute tolerance in managing breakpoints")
      .def_readwrite("BKPTRTOL", &PWCU::Options::BKPTRTOL,
                     "relative tolerance in managing breakpoints")
      .def_readwrite("DISPNUM", &PWCU::Options::DISPNUM,
                     "number of digits displayed")
      .def(
          "reset", [](PWCU::Options& self) { return self.reset(); },
          "reset options");
}
