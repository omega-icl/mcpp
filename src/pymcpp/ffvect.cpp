...
mc_ffvect(py::module_& m)
{
  ...
  pyVect.def(py::init<>(), "default constructor")
      .def(py::init<mc::FFGraph*, std::vector<mc::FFVar> const&,
           ...
           "constructor passing current DAG, dependent and independent "
           "variables")
      .def(py::init<mc::FFGraph*, std::vector<mc::FFVar> const&,
                    std::vector<mc::FFVar> const&,
                    std::vector<std::vector<mc::FFVar>> const&>(),
           "constructor passing current DAG, dependent, independent and "
           "constant variables")
      .def(py::init<mc::Vect const&>(), "copy constructor")
      .def(
          "set",
      ...
      .def_readwrite("options", &mc::Vect::options)
      .def_property_readonly(
          "DAG", [](mc::Vect& self) { return self.pDAG(); }, "Original DAG")
      .def_property_readonly(
  ...
  pyFFVect.def(py::init<>(), "default constructor")
      .def(
          "__call__",
