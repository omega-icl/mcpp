...
mc_ffdep(py::module_& m)
{
  ...
  pyFDExceptions.def("ierr", &FD::Exceptions::ierr, "Error flag")
  ...
  pyFFDep
      ...
      .def(py::init<FD const&>(), "Copy constructor")
      ...
      .def(
          ...
          py::arg("ndx"), "Determine dependency on variable with index 'ndx'")
      .def(
          "dep", [](FD const& self) { return self.dep(); },
          "Dictionary of dependencies")
      .def("worst", &FD::worst, "Worst-case dependency")
      .def("update", &FD::update, "Update dependency")
  ...
  m.def("prod", [](unsigned n, std::vector<FD> const& x)
