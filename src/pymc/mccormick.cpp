...
mc_mccormick(py::module& m)
{
  ...
  pyMcCormick.def(py::init<>(), "default constructor")
      .def(py::init<double const&>(), "constructor for constant value")
      .def(py::init<I const&>(), "constructor for constant interval")
      .def(py::init<I const&, double const&>(),
           "constructor for range and equal convex and concave bounds")
      .def(py::init<I const&, double const&, double const&>(),
           "constructor for range, convex and concave bounds")
      .def(py::init<MC const&>(), "copy constructor")
      .def_readwrite_static("options", &MC::options)
      .def_property_readonly(
          "l", [](MC& self) { return self.l(); }, "variable lower range")
      .def_property_readonly(
          "u", [](MC& self) { return self.u(); }, "variable upper range")
      .def_property(
          "I", [](MC& self) { return self.I(); },
          [](MC& self, I const& I) { self.I() = I; }, "variable range")
      .def_property(
          "cv", [](MC& self) { return self.cv(); },
          [](MC& self, double const& cv) { self.cv(cv); }, "convex bound")
      .def_property(
          "cc", [](MC& self) { return self.cc(); },
          [](MC& self, double const& cc) { self.cc(cc); }, "concave bound")
      .def(
          "c", [](MC& self, double const& c) { return self.c(c); },
          "set convex and concave bounds")
      .def_property_readonly(
          "nsub", [](MC& self) { return self.nsub(); }, "subgradient size")
      .def_property_readonly(
          "cvsub",
          [](MC& self) {
          ...
          py::return_value_policy::take_ownership, "convex bound subgradient")
      .def_property_readonly(
          "ccsub",
          [](MC& self) {
          ...
          py::return_value_policy::take_ownership, "concave bound subgradient")
      .def("sub", static_cast<MC& (MC::*)(unsigned int const)>(&MC::sub),
           py::arg("size"), "set subgradient size")
      .def("sub",
           static_cast<MC& (MC::*)(unsigned int const, unsigned int const)>(
               &MC::sub),
           py::arg("size"), py::arg("index"),
      ...
      .def(
          ...
          py::arg("ccsub"), "set subgradient values")
      .def("cut", static_cast<MC& (MC::*)()>(&MC::cut))
      .def(
          "laff",
          ...
          py::arg("val"), py::arg("ref"), "affine underestimator value")
      .def(
          "laff",
          ...
          py::arg("rng"), py::arg("ref"), "affine underestimator bound")
      .def(
          "uaff",
          [](MC& self, std::vector<double> const& val,
             std::vector<double> const& ref)
          ...
          py::arg("val"), py::arg("ref"), "affine overestimator value")
      .def(
          "uaff",
          [](MC& self, std::vector<I> const& rng,
             std::vector<double> const& ref)
          ...
          py::arg("rng"), py::arg("ref"), "affine overestimator bound")
  ...
  pyMcCormickOptions.def(py::init<>())
  ...
  m.def("max", [](MC const& x, MC const& y) { return mc::max(x, y); });
  m.def("min", [](MC const& x, MC const& y) { return mc::min(x, y); });
  m.def("inter",
        [](MC& z, MC const& x, MC const& y) { return mc::inter(z, x, y); });
  m.def("ltcond", [](I const& z, MC const& x, MC const& y)
        { return mc::ltcond(z, x, y); });
  m.def("ltcond", [](MC const& z, MC const& x, MC const& y)
        { return mc::ltcond(z, x, y); });
  m.def("gtcond", [](I const& z, MC const& x, MC const& y)
        { return mc::ltcond(z, x, y); });
  m.def("gtcond", [](MC const& z, MC const& x, MC const& y)
        { return mc::ltcond(z, x, y); });
}
