...
mc_fadbad_forward(py::module& m)
{
  ...
  pyFadbadF
      .def(py::init<MC const&>(), "construct forward automatic differentiation")
      .def(py::init<const double&>(),
           "construct forward automatic differentiation")
      .def(py::init<const FMC&>(), "copy constructor")
      .def_property_readonly(
          "value", [](FMC const& self) { return self.val(); }, "value")
      .def_property_readonly(
          "size", [](FMC const& self) { return self.size(); }, "size")
      .def(
          "__getitem__", [](FMC const& self, unsigned int i)
          { return self.operator[](i); }, "get ith derivative")
      .def(
          "variable", [](FMC& self) { return self.x(); }, "return variable")
      .def(
          "deriv", [](FMC& self, const unsigned int i)
          { return self.deriv(i); }, "get ith derivative")
      .def(
          "diff", [](FMC& self, unsigned int i, unsigned int N)
          { return self.diff(i, N); }, "calculate derivative")
      .def(
          "depend", [](FMC const& self) { return self.depend(); },
          "check if dependent")
      .def(
      ...
      .def(
          ...
          { self.setDepend(val1, val2); }, "set dependent")
...
mc_fadbad_backward(py::module& m)
{
  ...
  pyFadbadB
      .def(py::init<MC const&>(),
           "construct backward automatic differentiation")
      .def(py::init<const double&>(),
           "construct backward automatic differentiation")
      .def(py::init<const BMC&>(), "copy constructor")
      .def_property_readonly(
          "value", [](BMC const& self) { return self.val(); }, "value")
      .def(
          "variable", [](BMC& self) { return self.x(); }, "return variable")
      .def(
...
mc_fadbad_taylor(py::module& m)
{
  ...
  pyFadbadT
      .def(py::init<MC const&>(), "construct taylor automatic differentiation")
      .def(py::init<const double&>(),
           "construct taylor automatic differentiation")
      .def(py::init<const TMC&>(), "copy constructor")
      .def_property_readonly(
          "value", [](TMC const& self) { return self.val(); }, "value")
      .def_property_readonly(
          "size", [](TMC const& self) { return self.length(); }, "size")
      .def(
          "__getitem__", [](TMC const& self, unsigned int i)
          { return self[i]; }, "get ith derivative")
      .def(
          "__setitem__", [](TMC& self, unsigned int i, double const& val)
          { self[i] = val; }, "set ith derivative")
      .def(
          "reset", [](TMC& self) { return self.reset(); }, "reset value")
      .def(
