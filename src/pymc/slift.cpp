...
mc_slift(py::module_& m)
{
  ...
  pySLiftVar
      ...
      .def(py::init<SV const&>(), "Copy constructor")
      .def("env", &SV::env, py::return_value_policy::reference_internal,
  ...
  m.def(
      ...
      { return mc::prod(x.size(), x.data()); }, py::arg("x"));
  m.def(
      "prod",
  ...
  pySLOptions.def(py::init<>(), "Default constructor")
      ...
      .def_readwrite("KEEPFACT", &SL::Options::KEEPFACT,
                     "Whether to keep existing factorisations [Default: True]")
      .def_readwrite(
          "NOAUXIL", &SL::Options::NOAUXIL,
          "Whether to reformulate expressions without introducing auxiliary "
          "variables or lifting constraints [Default: False]")
      .def_readwrite("LIFTDIV", &SL::Options::LIFTDIV,
                     "Whether to lift division terms using auxiliary variables "
                     "[Default: False]")
      .def_readwrite("LIFTIPOW", &SL::Options::LIFTIPOW,
                     "Whether to lift integral power terms using auxiliary "
                     "variables [Default: False]")
      .def_readwrite(
          "LOG2EXP", &SL::Options::LOG2EXP,
          "Whether to convert log univariate to exp univariate [Default: True]")
      .def_readwrite("SQRT2SQR", &SL::Options::SQRT2SQR,
                     "Whether to convert sqrt univariate to sqr univariate "
                     "[Default: True]")
      .def_readwrite("ACOS2COS", &SL::Options::ACOS2COS,
                     "Whether to convert acos univariate to cos univariate "
                     "[Default: True]")
      .def_readwrite("ASIN2SIN", &SL::Options::ASIN2SIN,
                     "Whether to convert asin univariate to sin univariate "
                     "[Default: True]")
      .def_readwrite("ATAN2TAN", &SL::Options::ATAN2TAN,
                     "Whether to convert atan univariate to tan univariate "
                     "[Default: False]")
      .def_readwrite("TAN2ATAN", &SL::Options::TAN2ATAN,
                     "Whether to convert tan univariate to atan univariate "
                     "[Default: True]")
      .def_readwrite("DISPFULL", &SL::Options::DISPFULL,
                     "Whether to display a full subgraph of the lifted "
  ...
  pySLiftEnv
      .def(py::init<FG*>(), py::arg("dag") = nullptr,
           ...
           "Constructor")
      .def_readwrite("options", &SL::options,
      ...
      .def("set", &SL::set, py::arg("dag"),
           py::keep_alive<1, 2>(),  // SLiftEnv stores a raw FFGraph*
           "Attached DAG")
      .def("reset", &SL::reset, "Reset intermediate expressions")
      .def("process",
           py::overload_cast<std::vector<FV> const&, bool const>(&SL::process),
           py::arg("vDep"), py::arg("add2dag") = true,
      ...
      .def_property_readonly("var", &SL::Var,
                             py::return_value_policy::reference_internal,
                             "List of new (auxiliary) variables participating "
                             "in lifted expressions")
      .def_property_readonly(
          ...
          py::return_value_policy::reference_internal,
          "List of tuples between initial DAG intermediates and new "
          "(auxiliary) variables")
      .def_property_readonly("OpLift", &SL::OpLift,
                             py::return_value_policy::reference_internal,
                             "List of intermediate expressions for lifted "
                             "operations (tuples: {Op, [Operands]})")
      .def_property_readonly("AuxLift", &SL::AuxLift,
                             py::return_value_policy::reference_internal,
                             "List of intermediate expressions for lifted "
                             "variables (tuples: {Var, SLiftVar})")
      .def(
          "insert_dag",
      ...
      .def(
          ...
          py::arg("dagaux") = false, "Transcribe sparse polynomial into DAG")
      .def(
          "lift",
