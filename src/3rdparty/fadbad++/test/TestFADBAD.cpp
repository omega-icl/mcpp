...
struct Cot
{
	static const char* Name(){ return "T cot(const T&)"; }
	static const int m=1;
	static const int n=1;
	template <typename T>
	std::vector<T> operator()(const std::vector<T>& v)
...
struct Sinh
{
	static const char* Name(){ return "T sinh(const T&)"; }
	static const int m=1;
	static const int n=1;
	template <typename T>
	std::vector<T> operator()(const std::vector<T>& v)
...
struct Cosh
{
	static const char* Name(){ return "T cosh(const T&)"; }
	static const int m=1;
	static const int n=1;
	template <typename T>
	std::vector<T> operator()(const std::vector<T>& v)
...
struct Coth
{
	static const char* Name(){ return "T coth(const T&)"; }
	static const int m=1;
	static const int n=1;
	template <typename T>
	std::vector<T> operator()(const std::vector<T>& v)
...
void TestFADBAD::run(IReportLog& rlog)
{
	...
	{ check<Cot> chk; chk.runFB(rlog); }
	{ check<ASin> chk; chk.runFB(rlog); }
	{ check<ACos> chk; chk.runFB(rlog); }
	{ check<ATan> chk; chk.runFB(rlog); }
	{ check<Sinh> chk; chk.runFB(rlog); }
	{ check<Cosh> chk; chk.runFB(rlog); }
	{ check<Tanh> chk; chk.runFB(rlog); }
	{ check<Coth> chk; chk.runFB(rlog); }
	...
	{ check<Cot> chk; chk.runFFB(rlog); }
	{ check<ASin> chk; chk.runFFB(rlog); }
	{ check<ACos> chk; chk.runFFB(rlog); }
	{ check<ATan> chk; chk.runFFB(rlog); }
	{ check<Sinh> chk; chk.runFFB(rlog); }
	{ check<Cosh> chk; chk.runFFB(rlog); }
	{ check<Tanh> chk; chk.runFFB(rlog); }
	{ check<Coth> chk; chk.runFFB(rlog); }
